                                    ...
                                    <div class="edm-block-posts-wrapper">
                                        <ul id="blockCarousel" class="cS-hidden">
                                            <li class="edm-carousel-list layout2">
                                                <div class="edm-single-post edm-clearfix">
                                                    <div class="edm-post-thumb">
                                                        ...
                                                        <img width="555" style="height:300px;" src="{{asset('img/road2.jpg')}}" class="attachment-education-master-carousel-blog size-education-master-carousel-blog wp-post-image" alt="" />								</a>
                                                    </div>
                                                    <!-- .edm-post-thumb -->
                                            ...
                                            <li class="edm-carousel-list layout2">
                                                <div class="edm-single-post edm-clearfix">
                                                    <div class="edm-post-thumb">
                                                        ...
                                                        <img width="555" style="height:300px;" src="{{asset('img/constr1.jpg')}}" class="attachment-education-master-carousel-blog size-education-master-carousel-blog wp-post-image" alt="" />								</a>
                                                    </div>
                                                    <!-- .edm-post-thumb -->
                                                    <div class="edm-post-content">
                                                        <h3 class="edm-post-title small-size"><a
                                            ...
                                            <li class="edm-carousel-list layout2">
                                                <div class="edm-single-post edm-clearfix">
                                                    <div class="edm-post-thumb">
                                                        <a href="new-admission-information/index.html">
                                                        <img width="555" style="height:300px;" src="{{asset('img/constr.jpg')}}" class="attachment-education-master-carousel-blog size-education-master-carousel-blog wp-post-image" alt="" />								</a>
                                                    </div>
                                                    <!-- .edm-post-thumb -->
                                                    <div class="edm-post-content">
                                                        <h3 class="edm-post-title small-size"><a
                                            ...
                                            <li class="edm-carousel-list layout2">
                                                <div class="edm-single-post edm-clearfix">
                                                    <div class="edm-post-thumb">
                                                        ...
                                                        <img width="555" style="height:300px;" src="{{asset('img/agri.jpg')}}"class="attachment-education-master-carousel-blog size-education-master-carousel-blog wp-post-image" alt="" />								</a>
                                                    </div>
                                                    <!-- .edm-post-thumb -->
                                                    <div class="edm-post-content">
                                                        <h3 class="edm-post-title small-size"><a
