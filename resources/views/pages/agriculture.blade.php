                        ...
                        <main id="main" class="site-main" role="main">
                            <article id="post-73" class="post-73 post type-post status-publish format-standard has-post-thumbnail hentry category-engineering category-post">
                                <div class="edm-article-thumb">
                                    <img width="960" height="640" src="{{asset('img/agric5.jpg')}}" class="attachment-full size-full wp-post-image" alt="" sizes="(max-width: 960px) 100vw, 960px" />	
                                </div>
                                <!-- .edm-article-thumb -->
                                ...
                                <div class="edm-related-posts-wrap edm-clearfix">
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:160px;" src="{{asset('img/agric2.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Supplies</a></h3>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        ...
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Marketing</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:160px;" src="{{asset('img/agri.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Agricultural Materials</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
