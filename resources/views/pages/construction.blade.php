                        ...
                        <main id="main" class="site-main" role="main">
                            <article id="post-73" class="post-73 post type-post status-publish format-standard has-post-thumbnail hentry category-engineering category-post">
                                <div class="edm-article-thumb">
                                   <img width="960" style="height:500px;" src="{{asset('img/materials.jpg')}}" class="wp-post-image" alt="" >
                                    {{--<img width="960" height="640" src="{{asset('img/coffee-2608864_960_7201.jpg')}}" class="attachment-full size-full wp-post-image" alt="" srcset="https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/coffee-2608864_960_7201.jpg 960w, https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/coffee-2608864_960_7201-300x200.jpg 300w, https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/coffee-2608864_960_7201-768x512.jpg 768w" sizes="(max-width: 960px) 100vw, 960px" />--}}
                                </div>
                                <!-- .edm-article-thumb -->
                                <header class="entry-header">
                                    <h1 class="entry-title">General Construction</h1>
                                    <!-- .entry-meta -->
                                </header>
                                <!-- .entry-header -->
                                ...
                                <div class="edm-related-posts-wrap edm-clearfix">
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:180px;" src="{{asset('img/property2.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Houses</a></h3>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:180px;" src="{{asset('img/estates.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" /></a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Schools</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:180px;" src="{{asset('img/soroti7.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt=""/>						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Hospitals</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
