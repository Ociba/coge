                        ...
                        <main id="main" class="site-main" role="main">
                            <article id="post-73" class="post-73 post type-post status-publish format-standard has-post-thumbnail hentry category-engineering category-post">
                                ...
                                <header class="entry-header">
                                    <h1 class="entry-title">Architecture (House Plan Drawing)</h1>
                                    <!-- .entry-meta -->
                                </header>
                                <!-- .entry-header -->
                                ...
                                <div class="edm-related-posts-wrap edm-clearfix">
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:140px;" src="{{asset('img/house.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" /></a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Front</a></h3>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:140px;" src="{{asset('img/house2.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" /></a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Back</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            ...
                                            <img width="305" style="height:140px;" src="{{asset('img/house3.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" /></a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                            <h3 class="edm-post-title small-size"><a href="#">Inside</a></h3>
                                            <div class="edm-post-meta">
                                                <span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">Work Efficiency is Our Result</a></span></span>						
                                            </div>
                                        </div>
